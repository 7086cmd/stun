...
// node_modules/.pnpm/fetch-blob@3.1.3/node_modules/fetch-blob/index.js
...
// node_modules/.pnpm/fetch-blob@3.1.3/node_modules/fetch-blob/file.js
...
// node_modules/.pnpm/fetch-blob@3.1.3/node_modules/fetch-blob/from.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/utils/multipart-parser.js
...
var require_minimatch = __commonJS({
  "node_modules/.pnpm/minimatch@3.0.4/node_modules/minimatch/minimatch.js"(exports, module) {
    ...
    minimatch.match = function(list2, pattern, options) {
      ...
      list2 = list2.filter(function(f3) {
        return mm.match(f3);
      });
  ...
  "node_modules/.pnpm/glob@7.2.0/node_modules/glob/common.js"(exports) {
    ...
    function setopts(self2, pattern, options) {
      ...
      if (!ownProp(options, "cwd"))
        ...
        self2.changedCwd = self2.cwd !== cwd6;
      }
...
var lint_default = async (folder, ext) => {
  const eslint = new ESLint();
  const __dirname2 = cwd();
  const results = await eslint.lintFiles([resolve(__dirname2, folder, `./*${ext}`), resolve(__dirname2, folder, `./**/*${ext}`)]);
  let tw = 0, te = 0;
  let hasw = false;
  for (let i2 = 0; i2 in results; i2++) {
    if (results[i2].messages.length != 0) {
      console.log(chalk.underline(results[i2].filePath));
      hasw = true;
    }
    for (let j = 0; j in results[i2].messages; j++) {
      if (results[i2].messages[j].severity == 1) {
        console.log("  " + chalk.dim(`${results[i2].messages[j].line}:${results[i2].messages[j].column}`) + "  " + chalk.yellow("warning") + "  " + results[i2].messages[j].message + "  " + chalk.dim(results[i2].messages[j].ruleId));
      } else if (results[i2].messages[j].severity == 2) {
        console.log("  " + chalk.dim(`${results[i2].messages[j].line}:${results[i2].messages[j].column}`) + "  " + chalk.red("error") + "  " + results[i2].messages[j].message + "  " + chalk.dim(results[i2].messages[j].ruleId));
      }
    }
    if (results[i2].messages.length != 0) {
      console.log();
    }
    tw += results[i2].warningCount;
    te += results[i2].errorCount;
  }
  if (hasw) {
...
// src/modules/lintfix.ts
import { ESLint as ESLint2 } from "eslint";
import { resolve as resolve2 } from "path";
import { cwd as cwd2 } from "process";
import chalk2 from "chalk";
var lintfix_default = async (folder, ext) => {
  const eslint = new ESLint2({
    fix: true
  });
  const __dirname2 = cwd2();
  const results = await eslint.lintFiles([resolve2(__dirname2, folder, `./*${ext}`), resolve2(__dirname2, folder, `./**/*${ext}`)]);
  await ESLint2.outputFixes(results);
  let tw = 0, te = 0;
  let hasw = false;
  for (let i2 = 0; i2 in results; i2++) {
    if (results[i2].messages.length != 0) {
      console.log(chalk2.underline(results[i2].filePath));
      hasw = true;
    }
    for (let j = 0; j in results[i2].messages; j++) {
      if (results[i2].messages[j].severity == 1) {
        console.log("  " + chalk2.dim(`${results[i2].messages[j].line}:${results[i2].messages[j].column}`) + "  " + chalk2.yellow("warning") + "  " + results[i2].messages[j].message + "  " + chalk2.dim(results[i2].messages[j].ruleId));
      } else if (results[i2].messages[j].severity == 2) {
        console.log("  " + chalk2.dim(`${results[i2].messages[j].line}:${results[i2].messages[j].column}`) + "  " + chalk2.red("error") + "  " + results[i2].messages[j].message + "  " + chalk2.dim(results[i2].messages[j].ruleId));
      }
    }
    if (results[i2].messages.length != 0) {
      console.log();
  ...
  if (hasw) {
    console.log(chalk2.bold.yellow(`\u2716 ${tw + te} problems (${te} errors, ${tw} warnings)`));
  }
};

// src/modules/create.ts
import { mkdirSync, writeFileSync, existsSync, readdirSync, statSync as statSync2, copyFileSync } from "fs";
import { resolve as resolve3 } from "path";
import { cwd as cwd3 } from "process";
import chalk3 from "chalk";

// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/index.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/body.js
init_fetch_blob();
init_esm_min();
import Stream, { PassThrough } from "node:stream";
import { types, deprecate } from "node:util";

// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/errors/base.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/errors/fetch-error.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/utils/is.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/headers.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/utils/is-redirect.js
var redirectStatus = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]);
var isRedirect = (code) => {
  return redirectStatus.has(code);
};

// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/response.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/request.js
import { format as formatUrl } from "node:url";

// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/utils/get-search.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/utils/referrer.js
...
// node_modules/.pnpm/node-fetch@3.1.0/node_modules/node-fetch/src/errors/abort-error.js
...
var copyDir = (src, dest) => {
  ...
  dir.forEach((item) => {
    const itemPath = resolve3(src, item);
    const lstType = statSync2(itemPath);
    if (lstType.isFile()) {
      copyFileSync(itemPath, resolve3(dest, item));
    } else if (lstType.isDirectory()) {
      copyDir(itemPath, resolve3(dest, item));
    }
  });
};
var generateReadme = (base, config) => {
  const readme = `# ${config.name}
${config.description}`;
  writeFileSync(resolve3(base, "./README.md"), readme);
};
var generatePrettierRC = (base) => {
  const prettierrc = {
    arrowParens: "always",
  ...
  writeFileSync(resolve3(base, "./.prettierrc.json"), JSON.stringify(prettierrc, null, 4));
};
var generateESLintRC = (base) => {
  const eslintrc = {
    env: {
      es2021: true,
      node: true,
  ...
  writeFileSync(resolve3(base, "./.eslintrc.json"), JSON.stringify(eslintrc, null, 4));
};
var generateIgnoreFiles = (base) => {
  const ignores = `# Logs
logs
*.log
npm-debug.log*
...
*.sw?
`;
  writeFileSync(resolve3(base, "./.eslintignore"), ignores);
  writeFileSync(resolve3(base, "./.npmignore"), ignores);
  writeFileSync(resolve3(base, "./.prettierignore"), ignores);
  writeFileSync(resolve3(base, "./.gitignore"), ignores);
};
var generatePackageJson = (base, config) => {
  const packageFile = __spreadProps(__spreadValues({}, config), {
    main: "src/main.ts",
    repository: {
      type: "git",
  ...
  writeFileSync(resolve3(base, "./package.json"), JSON.stringify(packageFile, null, 4));
};
var generateTSConfig = (base) => {
  const tsconfig = {
    compilerOptions: {
      target: "esnext",
  ...
  writeFileSync(resolve3(base, "./tsconfig.json"), JSON.stringify(tsconfig, null, 4));
};
var create_default = () => {
  prompts([
    {
    ...
    const license = await (await fetch(`https://api.github.com/licenses/${response.license}`)).json();
    if (license.body == void 0) {
      console.error(chalk3.red("You can not connect to https://api.github.com. We can not download the license file."));
      prompts({
        type: "confirm",
        name: "still",
        ...
        if (still.still) {
          ...
          console.error(chalk3.red("You exited the createment"));
          process.exit(1);
        }
      });
    } else {
    ...
    function generate() {
      const base = resolve3(cwd3(), response.name);
      mkdirSync(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`package.json`) + "..."));
      generatePackageJson(base, response);
      if (license.body !== void 0) {
        console.log(chalk3.yellow("Generating " + chalk3.bold(`LICENSE`) + "..."));
        writeFileSync(resolve3(base, "./LICENSE"), license.body);
      }
      mkdirSync(resolve3(base, "src"));
      mkdirSync(resolve3(base, "docs"));
      mkdirSync(resolve3(base, "src", "pages"));
      mkdirSync(resolve3(base, "test"));
      mkdirSync(resolve3(base, "public"));
      console.log(chalk3.yellow("Installizating " + chalk3.bold(`vite`) + "..."));
      copyFileSync(resolve3(__dirname, "template-vue-ts", "vite.config.ts"), resolve3(cwd3(), response.name, "vite.config.ts"));
      copyFileSync(resolve3(__dirname, "template-vue-ts", "index.html"), resolve3(cwd3(), response.name, "index.html"));
      copyDir(resolve3(__dirname, "template-vue-ts", "src"), resolve3(cwd3(), response.name, "src", "pages"));
      console.log(chalk3.yellow("Generating " + chalk3.bold(`tsconfig.json`) + "..."));
      generateTSConfig(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`src/main.ts`) + "..."));
      generateMainTS(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`ignores`) + "..."));
      generateIgnoreFiles(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`.eslintrc.json`) + "..."));
      generateESLintRC(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`.prettierrc.json`) + "..."));
      generatePrettierRC(base);
      console.log(chalk3.yellow("Generating " + chalk3.bold(`README.md`) + "..."));
      generateReadme(base, response);
      console.log(chalk3.green("Create " + chalk3.bold(response.name) + " successfully!"));
      console.log();
      console.log(chalk3.greenBright(`$ cd ${response.name}
$ pnpm install`));
      console.log();
      console.log(chalk3.green(`to installize your project.`));
    }
  });
};

// src/modules/serve.ts
...
var list = [
  ...import_glob.default.sync(resolve4(cwd4(), "./src/modules/**/*.*")),
  ...import_glob.default.sync(resolve4(cwd4(), "./src/modules/*.*")),
  ...import_glob.default.sync(resolve4(cwd4(), "./src/client/**/*.*")),
  ...import_glob.default.sync(resolve4(cwd4(), "./src/client/*.*")),
  resolve4(cwd4(), "./src/*.*")
];
var serve_default = async () => {
  await lint_default("src", ".ts");
  await lint_default("src", ".vue");
  await lint_default("src", ".js");
  build({
    entryPoints: list,
    outdir: resolve4(cwd4(), "dist"),
    platform: "node",
    format: "cjs",
    loader: {
      ".ts": "ts",
    ...
    watch: {
      onRebuild: (error) => {
        if (error) {
          console.log(chalk4.red("Build Failed: " + error.message));
        }
      }
    },
    target: ["node16"],
...
var build2 = async () => {
  ...
  await lint_default("src", ".js");
  await buildBackEnd({
    entryPoints: [resolve5(cwd5(), "src/main.ts")],
    outdir: resolve5(cwd5(), "dist"),
    bundle: true,
    platform: "node",
    format: "cjs",
    minify: true,
  ...
  await buildBackEnd({
    entryPoints: [resolve5(cwd5(), "src/preload.ts")],
    outdir: resolve5(cwd5(), "dist"),
    bundle: true,
    platform: "node",
    format: "cjs",
  ...
  await buildBackEnd({
    entryPoints: [resolve5(cwd5(), "src/client/main.js")],
    outdir: resolve5(cwd5(), "dist"),
    bundle: true,
    platform: "node",
    format: "cjs",
  ...
  await buildBackEnd({
    entryPoints: [resolve5(cwd5(), "src/client/preload.ts")],
    outdir: resolve5(cwd5(), "dist"),
    bundle: true,
    platform: "node",
    format: "cjs",
...
var build_default = build2;

// src/main.ts
var program = new Command();
program.version("1.0.0");
program.command("lint <folder> <ext>").option("-f, --fix", "Fix fixable problems.").action((folder, ext, options) => {
  if (options.fix == true) {
    lintfix_default(folder, ext);
  } else {
    lint_default(folder, ext);
  }
});
